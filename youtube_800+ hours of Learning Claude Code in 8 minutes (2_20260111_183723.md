...
context window, system prompt, [music]
and tool use permissions. So, they are
great for offloading smaller and more
specific tasks. But what I see people
doing with sub agents is they assign
them to act as specific roles like a
front-end developer, a UIUX designer or
a product manager. And I can tell you I
spent a good couple of hours trying to
work with agents this way. And the
results were pretty bad compared to just
using claude code with no agent specific
...
---
*추출 시간: 2026-01-11T18:37:23.631023*
